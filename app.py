...
try:
    data = yf.download(subsektor_stock, start=pd.todate_time(target_date_subsektor), end=pd.to_datetime(target_date_subsektor) + pd.DateOffset(months = 3), interval = '1d')['Close']
